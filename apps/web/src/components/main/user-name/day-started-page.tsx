      ...
      >
        ...
        <div className="mt-4 flex justify-center">
          <img
            ...
            className={cn(
              "h-36 w-36 rounded-full object-cover border-4 border-background shadow-lg shadow-primary-950/15 ring-4 ring-primary-200/70 dark:ring-primary-800/70 sm:h-40 sm:w-40 md:h-44 md:w-44"
            )}
          />
        </div>
        ...
        <div className="mt-7 flex justify-center">
          <div
            className={cn(
              "tick-pop flex h-16 w-16 items-center justify-center rounded-full bg-accent-100 text-4xl font-bold text-accent-700 shadow-lg shadow-accent-600/15 ring-4 ring-accent-200/50 dark:bg-accent-950/40 dark:text-accent-300 dark:ring-accent-800/60"
            )}
          >
            ✓
          </div>
        ...
        <h1
          className={cn(
            "mt-6 font-brand-secondary text-2xl font-bold tracking-tight text-foreground sm:text-3xl"
          )}
        >
        ...
        <button
          ...
          className={cn(
            ...
            completedStep >= 3 && [
              "cursor-not-allowed bg-accent-600 text-accent-50 shadow-md shadow-accent-600/20 dark:bg-accent-700",
            ]
          )}
        >
          {completedStep >= 3
